 ...
 */
final class Version20190910080513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD reset_token VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    }
