 ...
 */
final class Version20190913111827 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD cart JSON NOT NULL, ADD price NUMERIC(5, 2) NOT NULL, DROP basket');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD basket LONGTEXT NOT NULL COLLATE utf8mb4_bin, DROP cart, DROP price');
