...
class __TwigTemplate_63dd228fa41356b390df6698cee9572c5ae1ee3757ccffce3dc13a1ffdc3c600 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <main id=\"user_register\" class=\"container\">
        ...
        {% if erreur %}
            <p class=\"alert alert-danger col-md-8\">{{ erreur|join('<br>')|raw }}</p>
        {% endif %}
