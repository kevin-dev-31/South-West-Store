...
class __TwigTemplate_7d078ff41f955cc1fe71c1f4b414e03353b300f95135b21b4eb6dd4bfcea5a2b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <main id=\"login\" class=\"container\">
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"form-control\" placeholder=\"Email\" required>
            </p>
            <p>
        ...
        echo "\">Mot de passe oublié</a> | <a href=\"";
...
";
    ...
    {
        return array (  153 => 45,  137 => 32,  127 => 25,  121 => 21,  115 => 18,  111 => 17,  107 => 15,  105 => 14,  102 => 13,  96 => 11,  94 => 10,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <main id=\"login\" class=\"container\">
        <form method=\"post\" class=\"col-lg-6\">
            ...
            <p class=\"links\">
                <a href=\"{{ path('app_forgotten_password') }}\">Mot de passe oublié</a> | <a href=\"{{ path('app_register') }}\">S'inscrire</a>
            </p>

        </form>
    </main>
{% endblock %}
", "security/login.html.twig", "C:\\wamp64\\www\\Projet-soutenance\\shoes\\templates\\security\\login.html.twig");
    }
}
